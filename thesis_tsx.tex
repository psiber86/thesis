...
%% JOSH: second sentence ``will have to be <what> most of the time'' ?
...
%these? for these small pseudo code examples we should be ok.  
\begin{figure}
\begin{verbatim}
worker_thread()
...
%% JOSH: you must properly define the function you are not clear on before we can
%% distributed this thesis.
\vspace*{-\bigskipamount}
\begin{singlespace}
\begin{itemize}
