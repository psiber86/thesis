...
%TODO: compare individual sync mechs with their respective synch mechs using
%multiset
...
processed queues, and unprocessed queues were modified to use various
synchronization mechanisms as a stand alone solution to contention.  Performance
increased when the TSX Hardware Lock Elision interface was used.

To further alleviate contention, multiple LTSF queues were used in the
simulation.
%TODO: talk about how it didn't help that much

Another attempt to alleviate contention with multiple LTSF queues was the
migration of threads between LTSF queues.
